...
[TIP]
If you need to whitelist IPs or ports for connecting to the Anypoint Platform through a firewall, see link:/mule-agent/v/1.4.0/installing-mule-agent#ports-and-ips-to-whitelist[Ports and IPs to Whitelist].
